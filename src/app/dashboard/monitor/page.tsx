...
const PerformanceChart = dynamic(() => import("@/components/monitor-charts").then((mod) => ({ default: mod.PerformanceChart })), { ssr: false })
const UptimeChart = dynamic(() => import("@/components/monitor-charts").then((mod) => ({ default: mod.UptimeChart })), { ssr: false })
