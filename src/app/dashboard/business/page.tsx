...
const RevenueChart = dynamic(() => import("@/components/business-charts").then((mod) => ({ default: mod.RevenueChart })), { ssr: false })
const RevenueBarChart = dynamic(() => import("@/components/business-charts").then((mod) => ({ default: mod.RevenueBarChart })), { ssr: false })
const CustomerGrowthChart = dynamic(() => import("@/components/business-charts").then((mod) => ({ default: mod.CustomerGrowthChart })), { ssr: false })
const SalesByCategoryChart = dynamic(() => import("@/components/business-charts").then((mod) => ({ default: mod.SalesByCategoryChart })), { ssr: false })
